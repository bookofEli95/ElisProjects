     ...
     D WrkDupCount     S             10I 0 Inz(0)
      ...
      /free
         ...
         Dow Not %Eof(PCRSTAGE);
            ...
            // 0a. Force Title/Description to upper case on import.
            //     Author is deliberately NOT touched here - it's
            //     upper-cased further down, after Sbr_Match_Author
            //     runs, because that routine keys off the ORIGINAL
